...
CREATE TABLE Agent_Form_Info(
    ...
    Customer_Email VARCHAR (255) UNIQUE, -- Unique constraint
    Customer_Phone_Number VARCHAR (15) UNIQUE, -- Unique constraint
    Customer_Address TEXT, -- Changed from VARCHAR(255) to TEXT
    ...
    user_role ENUM('Financial Consultant', 'Agency Director') NOT NULL DEFAULT 'Financial Consultant',
